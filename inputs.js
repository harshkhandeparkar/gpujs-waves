...
// [Amplitude, Ang Freq, Ang Wave No, Phase Diff]
let HTMLWave1Params = ['0.5', 'pi', '-pi/2', 'pi']; // String values for pi which will finally be evaluated
let HTMLWave2Params = ['0.5', 'pi', 'pi/2', '0'];
